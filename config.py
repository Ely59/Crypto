...
MOMENTUM_S0_1H_MIN           = -2.0   # Stage 0: include coins down to -2.0% 1H (pre-breakout consolidation)
...
MOMENTUM_S0_BREAKOUT_WINDOW  = 120    # minutes: Stage 0 watchlist entry expires after this
...
MOMENTUM_ATH_DIST_L2          = 90.0   # > 90% below ATH → +15 pts (massive upside)
MOMENTUM_ATH_DIST_L1          = 80.0   # 80–90% below ATH → +10 pts (high upside)
MOMENTUM_ATH_DIST_L3          = 60.0   # 60–80% below ATH → +3 pts
MOMENTUM_ATH_DIST_P1          = 40.0   # 40–60% below ATH → 0 pts (neutral)
MOMENTUM_ATH_DIST_P2          = 20.0   # 20–40% below ATH → -5 pts (limited upside)
MOMENTUM_ATH_DIST_P3          = 10.0   # 10–20% below ATH → -12 pts (near ATH)
MOMENTUM_ATH_DIST_HARD_BLOCK  = 10.0   # < 10% below ATH → hard block, no alert
MOMENTUM_ATH_DIST_L2_PTS      = 15
MOMENTUM_ATH_DIST_L1_PTS      = 10
MOMENTUM_ATH_DIST_L3_PTS      = 3
MOMENTUM_ATH_DIST_P2_PTS      = -5
MOMENTUM_ATH_DIST_P3_PTS      = -12
...
# ─── GRIND Scanner ────────────────────────────────────────────────────────────
MOMENTUM_GRIND_MIN_CONSEC        = 4      # min consecutive green 5m candles above EMA20
MOMENTUM_GRIND_RSI_MAX           = 75.0   # RSI6 upper bound (not already overbought)
MOMENTUM_GRIND_MIN_DISPLACEMENT  = 0.5    # min % price gain vs 4 candles ago (20 min)
MOMENTUM_GRIND_VOL_MIN_FLOOR     = 0.20   # avg last-4 vol > 0.20× MA10 (alive check)
MOMENTUM_GRIND_ATH_DIST_MIN      = 10.0   # price ≥ 10% below 90d high
